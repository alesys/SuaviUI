--[[
    SuaviUI Castbar Options
    Extracted from sui_options.lua for better organization
    ...
    if unitKey == "player" or unitKey == "target" or unitKey == "targettarget" or unitKey == "focus" or unitKey == "pet" or unitKey == "boss" then
        ...
        local castCopyApplyBtn = GUI:CreateButton(castCopyRow, "Apply", 60, 24, function()
            if castCopyWrapper.selected then
                local sourceUnitDB = db.suiUnitFrames and db.suiUnitFrames[castCopyWrapper.selected]
        ...
        if unitKey == "player" then
            ...
            local defaultStageColors = SUI_Castbar and SUI_Castbar.STAGE_COLORS or {}
            local defaultFillColors = SUI_Castbar and SUI_Castbar.STAGE_FILL_COLORS or {}

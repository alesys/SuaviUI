...
local function CreateUnitFramesPage(parent)
    ...
    local function BuildUnitTab(tabContent, unitKey)
        ...
        -- FRAME SIZE section
        -- INFO MESSAGE: Frame positioning/size/appearance settings moved to Edit Mode sidepanel
        local infoHeader = GUI:CreateSectionHeader(tabContent, "Frame Settings")
        infoHeader:SetPoint("TOPLEFT", PAD, y)
        y = y - infoHeader.gap

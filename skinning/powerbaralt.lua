...
-- with a clean SUI-styled bar. Used for: Atramedes sound, Cho'gall
...
local function GetDB()
    ...
    return SUICore and SUICore.db and SUICore.db.profile or {}
end
...
local function CreateQUIAltPowerBar()
    ...
    local bar = CreateFrame("StatusBar", "SuaviUI_AltPowerBar", UIParent)
    ...
    bar.suiSkinColor = { sr, sg, sb, sa }
    bar.suiBgColor = { bgr, bgg, bgb, bga }
    bar.quiSkinned = true
...
local function RefreshPowerBarAltColors()
    ...
    QUIAltPowerBar.suiSkinColor = { sr, sg, sb, sa }
    QUIAltPowerBar.suiBgColor = { bgr, bgg, bgb, bga }
...
_G.SuaviUI_RefreshPowerBarAltColors = RefreshPowerBarAltColors
...
local function CreateMover()
    ...
    powerBarMover = CreateFrame("Frame", "SuaviUI_AltPowerBarMover", UIParent, "BackdropTemplate")
...
_G.SuaviUI_TogglePowerBarAltMover = ToggleMover
...
frame:SetScript("OnEvent", function(self, event)
    ...
    -- Delay slightly to ensure SUI is loaded

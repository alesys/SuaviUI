    ...
    local function BuildPowerbarTab(tabContent)
        ...
        snapPrimaryBtn:SetScript("OnClick", function()
            ...
            if essentialViewer and essentialViewer:IsShown() then
                ...
                print("|cFF56D1FFSuaviUI:|r Essential Cooldowns viewer not found or not visible.")
            end
        end)
        ...
        snapUtilityBtn:SetScript("OnClick", function()
            ...
            if utilityViewer and utilityViewer:IsShown() then
                ...
                print("|cFF56D1FFSuaviUI:|r Utility Cooldowns viewer not found or not visible.")
            end
        end)
        y = y - FORM_ROW
        ...
        snapSecEssentialBtn:SetScript("OnClick", function()
            if _G.SuaviUI_RefreshNCDM then _G.SuaviUI_RefreshNCDM() end
            local essentialViewer = _G.EssentialCooldownViewer
            if essentialViewer and essentialViewer:IsShown() then
                local rawCenterX, rawCenterY = essentialViewer:GetCenter()
                local rawScreenX, rawScreenY = UIParent:GetCenter()
        ...
        snapSecPrimaryBtn:SetScript("OnClick", function()
            ...
            if primaryBar and primaryBar:IsShown() and primaryCfg then
                ...
                print("|cFF56D1FFSuaviUI:|r Primary Class Resource Bar not found or not visible. Enable it first.")
            end
        end)
        y = y - FORM_ROW
...
local function BuildImportExportTab(tabContent)
    ...
    GUI:SetSearchContext({tabIndex = 13, tabName = "SUI Import/Export", subTabIndex = 1, subTabName = "Import/Export"})
...
local function BuildSuaviStringsTab(tabContent)
    ...
    GUI:SetSearchContext({tabIndex = 13, tabName = "SUI Import/Export", subTabIndex = 2, subTabName = "Suavi's Strings"})

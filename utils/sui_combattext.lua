...
local function GetSettings()
    ...
    if SUICore and SUICore.db and SUICore.db.profile and SUICore.db.profile.combatText then
        return SUICore.db.profile.combatText
    end
    return nil
end
...
local function CreateTextFrame()
    ...
    local frame = CreateFrame("Frame", "SuaviUI_CombatText", UIParent)
    ...
    text:SetTextColor(0.204, 0.827, 0.6, 1)  -- SUI mint accent
...
---------------------------------------------------------------------------
_G.SuaviUI_RefreshCombatText = RefreshCombatText

---------------------------------------------------------------------------
-- Global preview function for options panel
---------------------------------------------------------------------------
_G.SuaviUI_PreviewCombatText = function(message)
...
SUI.CombatText = {
    ...
    Show = ShowCombatText,
    Preview = _G.SuaviUI_PreviewCombatText,
}

...
-- Texture paths
local DOT_TEXTURE = "Interface\\AddOns\\SuaviUI\\assets\\cursor\\sui_reticle_dot"
...
local function GetSettings()
    ...
    if SUICore and SUICore.db and SUICore.db.profile and SUICore.db.profile.skyriding then
        return SUICore.db.profile.skyriding
    end
    return nil
end
...
local function GetFontPath()
    ...
    if SUI and SUI.GetGlobalFont then
...
local function CreateSkyridingFrame()
    ...
    skyridingFrame = CreateFrame("Frame", "SuaviUI_Skyriding", UIParent)
    ...
    -- Apply SuaviUI font to cooldown text (deferred to ensure template is initialized)
...
---------------------------------------------------------------------------
_G.SuaviUI_RefreshSkyriding = ApplySettings

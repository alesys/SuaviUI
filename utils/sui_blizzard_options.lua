---------------------------------------------------------------------------
-- SuaviUI Blizzard Options Integration
-- Registers SuaviUI in Settings > AddOns panel
---------------------------------------------------------------------------
local ADDON_NAME, ns = ...
local SUI = SuaviUI

local ADDON_DISPLAY_NAME = "suavi UI"

local function OpenSuaviUI()
    if SUI.GUI then
        SUI.GUI:Toggle()
        return true
    end
...
local function CreateSettingsPanel()
    ...
    local panel = CreateFrame("Frame", "SuaviUI_BlizzardSettingsPanel")

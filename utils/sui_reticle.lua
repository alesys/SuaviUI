...
---------------------------------------------------------------------------
local RING_TEXTURES = {
    thin     = "Interface\\AddOns\\SuaviUI\\assets\\cursor\\sui_ring_thin.png",
    standard = "Interface\\AddOns\\SuaviUI\\assets\\cursor\\sui_ring_standard.png",
    thick    = "Interface\\AddOns\\SuaviUI\\assets\\cursor\\sui_ring_thick.png",
    solid    = "Interface\\AddOns\\SuaviUI\\assets\\cursor\\sui_ring_solid.png",
}

-- Reticle options (mix of custom texture and Blizzard Atlas)
local RETICLE_OPTIONS = {
    dot     = { path = "Interface\\AddOns\\SuaviUI\\assets\\cursor\\sui_reticle_dot.tga", isAtlas = false },
...
local function GetSettings()
    ...
    if SUICore and SUICore.db and SUICore.db.profile and SUICore.db.profile.reticle then
        cachedSettings = SUICore.db.profile.reticle
...
local function CreateReticle()
    ...
    ringFrame = CreateFrame("Frame", "SuaviUI_Reticle", UIParent)
...
---------------------------------------------------------------------------
_G.SuaviUI_RefreshReticle = function()
    InvalidateCache()
    UpdateReticle()
end
